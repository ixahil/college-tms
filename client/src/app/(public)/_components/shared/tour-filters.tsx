...
export const TourFilters = ({ cities, states }) => {
  ...
  return (
    <>
      ...
      {/* City Filter */}
      <div className="mb-6">
        <h4 className="text-lg font-medium text-gray-700 mb-3">Cities</h4>
          ...
          {cities.map((c) => (
            <div key={c} className="flex items-center">
              <input
                ...
                onChange={() => pushQuery("city", c)}
                checked={searchParams.getAll("city").includes(c)}
              />
