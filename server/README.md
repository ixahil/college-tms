...
- `ACCESSTOKENSECRET`: Secret key for the access token.
- `REFRESHTOKENSECRET`: Secret key for the refresh token.
- `ACCESSTOKENEXPIRESIN`: Expiration time for access tokens (e.g., `1hour`).
- `REFRESHTOKENEXPIRESIN`: Expiration time for refresh tokens (e.g., `1hour`).
